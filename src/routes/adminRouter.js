...
router.post('/products/edit/:id',uploadFile.single('image'), validationsEdit, adminController.editProduct); //Envía los datos para almacenar los cambios de la edición
